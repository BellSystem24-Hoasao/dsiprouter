...
def createSessionMaker():
    ...
    dr_gateways = Table('dr_gateways', metadata, autoload_with=db_engine)
    address = Table('address', metadata, autoload_with=db_engine)
    outboundroutes = Table('dr_rules', metadata, autoload_with=db_engine)
    inboundmapping = Table('dr_rules', metadata, autoload_with=db_engine)
    subscriber = Table('subscriber', metadata, autoload_with=db_engine)
    dsip_domain_mapping = Table('dsip_domain_mapping', metadata, autoload_with=db_engine)
    dsip_multidomain_mapping = Table('dsip_multidomain_mapping', metadata, autoload_with=db_engine)
    # fusionpbx_mappings = Table('dsip_fusionpbx_mappings', metadata, autoload_with=db_engine)
    dsip_lcr = Table('dsip_lcr', metadata, autoload_with=db_engine)
    uacreg = Table('uacreg', metadata, autoload_with=db_engine)
    dr_gw_lists = Table('dr_gw_lists', metadata, autoload_with=db_engine)
    # dr_groups = Table('dr_groups', metadata, autoload_with=db_engine)
    domain = Table('domain', metadata, autoload_with=db_engine)
    domain_attrs = Table('domain_attrs', metadata, autoload_with=db_engine)
    dispatcher = Table('dispatcher', metadata, autoload_with=db_engine)
    dsip_endpoint_lease = Table('dsip_endpoint_lease', metadata, autoload_with=db_engine)
    dsip_maintmode = Table('dsip_maintmode', metadata, autoload_with=db_engine)
    dsip_calllimit = Table('dsip_calllimit', metadata, autoload_with=db_engine)
    dsip_notification = Table('dsip_notification', metadata, autoload_with=db_engine)
    dsip_hardfwd = Table('dsip_hardfwd', metadata, autoload_with=db_engine)
    dsip_failfwd = Table('dsip_failfwd', metadata, autoload_with=db_engine)
    dsip_cdrinfo = Table('dsip_cdrinfo', metadata, autoload_with=db_engine)
    dsip_certificates = Table('dsip_certificates', metadata, autoload_with=db_engine)
    dsip_dnid_enrichment = Table('dsip_dnid_enrich_lnp', metadata, autoload_with=db_engine)
    dsip_user = Table('dsip_user', metadata, autoload_with=db_engine)
